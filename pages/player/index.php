    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header"><h3>Menu</h3></li>
         <li><a href="viewStatus.php"><i class="glyphicon glyphicon-pencil text-green"></i> <span>View Status</span></a></li>
                  ...
                  <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                      ...
                      <li class="list-group-item">
                        ...
                        <a class="pull-right">
                          <button type="submit" class="btn bg-purple"> <span class="glyphicon glyphicon-send"></span> Send Request</button>
                        </a>
                      </li>
                    </ul>
                  </div>
