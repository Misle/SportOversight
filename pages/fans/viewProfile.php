    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header"><h3>Menu</h3></li>
         ...
         <li class = "active"><a href="viewProfile.php"><i class="glyphicon glyphicon-user text-yellow"></i> <span>View Profile</span></a></li>
        ...
        <div class="col-md-3">
          ...
          <div class=" ">
            <div class="box-body box-profile"><br><br><br>
              ...
              <p class="text-muted text-center">Ethiopian Buna Club Head</p>
              <br><br>
            </div>
            <!-- /.box-body -->
          </div>
                ...
                <div class="row"><br><br>
                  ...
                  <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                      ...
                      <li class="list-group-item">
                        <b>Fan Of</b> <a class="pull-right">Ethiopia Buna</a>
                      </li>
                    </ul>
                  </div>
