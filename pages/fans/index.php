    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header"><h3>Menu</h3></li>
         <li class = "active"><a href="index.php"><i class="glyphicon glyphicon-home text-green"></i> <span>Home</span></a></li>
        ...
        <div class = "col-md-7">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="box-body">
                <div class="row">
                  <div class="col-md-5"><img class="img-responsive" src="../../dist/img/photo1.png" alt="Photo"></div>
                  <div class="col-md-7">
                    <div class="box-body">
                      <blockquote>
