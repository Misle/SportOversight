    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header"><h3>Menu</h3></li>
         ...
         <li class = "active"><a href="liveStream.php"><i class="glyphicon glyphicon-facetime-video text-green"></i> <span>View Live Stream</span></a></li>
                  ...
                  <div class="box-header with-border">
                    <h3 class="box-title">Direct Match</h3>
	                 ...
	                 <!-- /.box-header -->
                        ...
                        <div id="getdata" style = 'overflow-y:scroll;overflow-x:hidden; height:350px;'></div>
