...
<?php
  if (isset($_POST["registerCoach"])) {
    # code...
    include "registerCoach_back_end.php";
  registerCoach();
  }
?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu active">
            ...
            <li class = "active"><a href="Register coach" class  = "active"><i class="fa fa-circle-o active"></i> Register Coach</a></li>
      ...
      <form method = 'post' action = "">
        ...
        <div class="row" id = "part1">
          ...
          <div class="col-md-6">
            <div class="box box-primary">
              ...
              <div class="box-body">
               ...
               <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Experiacne</h3>
                    ...
                    <div class="box-body no-padding">
                         <div class="item form-group">
                          <label class="control-label col-md-3" for="service">Coach Level</label>
                          <div class="col-md-8">


                             <select class="form-control select2 col-md-6" data-placeholder="Coach Level" style="width: 100%;" name  = "C_level">
                              <option>A-Licence </option>
                              <option>B-Licence </option>
                              <option>C-Licence </option>
          ...
          <!--/.col (right) -->
           <div class = "col-md-4">
            <center>
              <input type = "submit" value = "Register" class="btn bg-olive btn-flat" style = "width:200px; height:40px; font-size:18px;" id ="sub" name = "registerCoach">
            </center>
          </div>
        </div>
