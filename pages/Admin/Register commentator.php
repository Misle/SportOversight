...
<?php
  if (isset($_POST["registerComm"])) {

    include "registerCommentator_back_end.php";
    registerCommentator();
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu active">
            ...
            <li class  = "active"><a href="Register commentator" class  = "active"><i class="fa fa-circle-o active"></i>  Register Commentator</a></li>
...
<!--
      ...
      <form method = 'post'
        ...
        <div class="row" id = "part1">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="email" class="form-control" id="inputid" data-validate-length-range="1" data-validate-words="1" name="email" required="required" placeholder="Email">
                                    ...
                                    <div class="form-group">
                                      <label for="startdate" class="col-sm-3 control-label">Media Working For<span class="required" style = "color :red"> *</span></label>
                                      <div class="col-sm-7">
                                        <input type="text"  class="form-control" id="" data-validate-length-range="1" data-validate-words="1" name="mwf" required="required" placeholder="Media Working For">
                                      </div>
                                    </div>
          ...
          <!--/.col (right) -->
           <div class = "col-md-4">
            <center>
              <input type = "submit" value = "Register" class="btn bg-olive btn-flat" style = "width:200px; height:40px; font-size:18px;" id ="sub" name = "registerComm">
            </center>
          </div>
        </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; Sports Oversights</a>.</strong> All rights
    reserved.
  </footer>
