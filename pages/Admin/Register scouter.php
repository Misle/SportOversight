...
<?php
  if (isset($_POST["registerScouter"])) {
    # code...
    include "registerScouter_back_end.php";
    registerScouter();
  }
?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu active">
            ...
            <li class = "active"><a href="Register scouter" class  = "active"><i class="fa fa-circle-o active"></i>  Register Scouter</a></li>
...
<!--
        ...
        <li class="treeview">
         ...
         <li><a href="logut"><i class="glyphicon glyphicon-log-out text-red"></i> <span>LogOut</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
        ...
        <div class="row" id = "part1">
          ...
          <div class="col-md-6">
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <div class="box">
                    <div class="box-header">
                      <h3 class="box-title">Experiance</h3>
                    </div>
                    <br>
                    <!-- /.box-header -->
                    <div class="box-body no-padding">
                         <div class="item form-group">
                          <label class="control-label col-md-3" for="service">Scouter Level</label>
                          <div class="col-md-8">


                             <select class="form-control select2 col-md-6"  data-placeholder="Scouter Level" style="width: 100%;" name  = "scouter_level">
          ...
          <!--/.col (right) -->
           ...
           <div class = "col-md-4">
             <br>
            <center>
              <input type = "submit" value = "Register" class="btn bg-olive btn-flat" style = "width:200px; height:40px; font-size:18px;" id ="sub" name = "registerScouter">
            </center>
          </div>
        </div>
