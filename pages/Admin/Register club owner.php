...
<?php
  if (isset($_POST["btn22"])) {
    # code...
    include "regClubOwner_back_end.php";
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu active">
            ...
            <li class = "active"><a href="Register clubowner" class  = "active"><i class="fa fa-circle-o active"></i> Register ClubOwner</a></li>
          </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">
      ...
      <form method = 'post'>
        ...
        <div class="row" id = "part1">
          ...
          <div class="col-md-6">
            ...
            <div class="box">
              <div class="box-header">
                <h4 class="box-title">Club Information</h4>
              </div>
                 <div class="form-group">
                    <label for="clubowning" class="col-sm-3 control-label">Club Owning<span class="required" style = "color :red"> *</span></label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputid" data-validate-length-range="1" data-validate-words="1" name="clubowning" required="required" placeholder="Club Owning">
                    </div>
                  </div>
                </div>
                </div>
          ...
          <!--/.col (right) -->
           <div class = "col-md-4">
            <center>
              <input type = "submit" value = "Register" class="btn bg-olive btn-flat" style = "width:200px; height:40px; font-size:18px;" id ="sub" name = "btn22">
            </center>
          </div>
        </div>
